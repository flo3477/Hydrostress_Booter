        ...
        <form action="" method="POST">
            <fieldset>
                    <div class="control-group">
                        ...
                        <div class="formRight"><input type="text" style="width:250px; text-align:center;  height:40px" name="username" value="<?php echo htmlentities($username);?>"  readonly="readonly"/></div>
                        <div class="clear"></div>
                    </div>
                    
                    <div class="control-group">
                        <label>Email:</label>
                        <div class="formRight"><input type="text" style="width:250px; text-align:center;  height:40px" name="email" value="<?php echo htmlentities($email);?>" disabled /></div>
                        <div class="clear"></div>
                    </div>
                    <div class="control-group">
                        <label>Rank:</label>
                        <div class="formRight">
                            <select  style="width:250px; text-align:center;  height:40px" name="rank" disabled >
							<?php
