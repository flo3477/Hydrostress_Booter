...
<?php 
						...
						?>
                                    ...
                                    <li>
                                            <a href="#">
                                                <i class="fa fa-bullhorn"></i> <?php echo htmlentities($newsInfo['detail']); ?>
...
<?php
     ...
     <li>
                                            <a href="#">
                                                <i class="fa fa-thumbs-o-down warning"></i> No More News
<div class="control-group">
                                ...
                                <li class="footer"><a href="../news.php">View all</a></li>
                            </ul>
                        </li>
...
<div class="control-group">
 ...
 <li>
                            <a href="ticketcenter.php">
                                <i class="fa fa-ticket"></i> <span>Ticket Center</span>
                            </a>
                        </li>
 <li>
                            <a href="news.php">
