...
?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        BlackList
                        <small>Skype BlackList</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Skype BlackList</li>
                    </ol>
                </section>
		...
		if (isset($_POST['addBtn']))
		{
			...
			$noteAdd = $_POST['noteAdd'];
				...
				if (empty($ipAdd) || empty($noteAdd))
					...
					{
						$SQLinsert = $odb -> prepare("INSERT INTO `skypeblacklist` VALUES(NULL, :ip, :note)");
                        ...
                        <div class="col-md-6">
                            <div class="box box-warning">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Skype BlackList</h3>
...
<center><fieldset>
					...
					<input style="width:210px; text-align:center;  height:30px" placeholder="Skype Name" name="ipAdd" type="text"/>
<br>
<br>					
